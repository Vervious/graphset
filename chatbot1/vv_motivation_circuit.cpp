...
// Again, this version takes in an array of sentences, and returns an integer score, from
// 0 (no understanding) to something enormous.
int MotivationCircuit::understandingScoreForSentenceVectors(std::vector<std::string>) {
    // how do you compute understanding
    return 0;
}